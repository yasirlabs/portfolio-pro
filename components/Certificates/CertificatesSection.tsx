...
export default function Certificates() {
  ...
  // Çeviriler ve static data'yı birleştir
  const certificates = certificatesData.map((data, i) => ({
    ...data,
    title: t(`certificates.${i}.title`),
    issuer: t(`certificates.${i}.issuer`),
    date: t(`certificates.${i}.date`),
    category: t(`categories.${t(`certificates.${i}.category`)}`),
  }));
